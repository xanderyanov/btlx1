$(function () {
	...
	$(".xBtn1").on("click", function (e) {
		...
		var $this = $(this);
		$("body").addClass("stop");
		$this.next(".overlay1").fadeIn(300); /********* */
		$this.next(".overlay1").find(".innerPriceBox").slideDown(300); /********** */
	...
	$(".innerPriceBox__close").on("click", function (e) {
		...
		e.stopPropagation();
		var $this = $(this);
		$this.closest(".eCard__itemInner").find(".overlay1").fadeOut(300);
		$this.closest(".eCard__itemInner").find(".innerPriceBox").slideUp(300);
